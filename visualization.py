"python visualization.py gradcam --name resnet50 -a 2.6 -c 124 -n 6 --img-path data/val/ --ucag"
...
def parsing():
    ...
    parser.add_argument('--img-path', type=str, default='/path/to/imagenet')
...
# python demo_dir.py gradcam -c 124 -n 6 -a 2.6 --ucag --score
